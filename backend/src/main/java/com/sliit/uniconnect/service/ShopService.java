...
public class ShopService {
        ...
        public List<ProductResponseDTO> getClubProducts(String clubId) {
                return productRepository.findByClubIdAndActive(clubId, true).stream()
        ...
        public List<ProductResponseDTO> getAllActiveProducts(ProductCategory category, String clubId, String eventTag) {
                ...
                // Since we don't have eventTag or complex criteria out of the box in the
                // repository,
        ...
        public ShopStatsDTO getShopStats(String clubId) {
                ...
                long completed = orders.stream().filter(
                                o -> o.getStatus() == OrderStatus.COLLECTED || o.getStatus() == OrderStatus.COMPLETED)
                                .count();
        ...
        private OrderResponseDTO mapToOrderResponse(Order o) {
                ...
                return OrderResponseDTO.builder()
                                ...
                                .items(o.getItems() == null ? List.of()
                                                : o.getItems().stream().map(i -> OrderResponseDTO.OrderItemDTO.builder()
