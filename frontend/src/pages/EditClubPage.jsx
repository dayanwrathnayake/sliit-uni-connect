    ...
    <PageLayout>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-xl font-semibold text-gray-900">Edit Club</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <div>
            ...
            <input
              ...
              value={name}
              disabled
              className="border border-gray-200 bg-gray-50 rounded-lg px-3 py-2 text-sm w-full text-gray-400 cursor-not-allowed"
            />
            <p className="text-xs text-gray-400 mt-1">Club name cannot be changed after creation.</p>
          </div>
          ...
          {/* Profile pic */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Club Profile Picture</label>
            <AvatarUploader
          ...
          {/* Banner */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Club Banner</label>
            {bannerPreview && (
              <div className="mb-2 h-32 rounded-xl overflow-hidden border border-gray-200">
