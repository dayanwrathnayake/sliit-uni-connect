      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Discover and follow clubs on campus</p>
          </div>
          {canRequest && (
            <button
              onClick={() => setShowModal(true)}
              className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg px-4 py-2 text-sm font-medium flex items-center gap-2 transition-colors"
            >
        ...
        <div className="mb-5 relative">
          ...
          <input
            ...
            className="w-full pl-10 border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
          />
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-base font-semibold text-gray-700 mb-1">No clubs found</h3>
            <p className="text-sm text-gray-400">Try a different search term or category filter.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {filtered.map((club) => (
